...
urlpatterns = [
    ...
    re_path(
        r"^goods/(?P<pk>\d+)/edit/$", views.GoodsUpdateView.as_view(), name="goods_edit"
    ),
    path("goods/<int:pk>/delete", views.GoodsDeleteView.as_view(), name="goods_delete"),
    re_path(
        r"^goods/(?P<pk>\d+)/delete/$",
    ...
    re_path(
        r"^customers/add/$", views.CustomerCreateView.as_view(), name="customer_add"
    ),
    path(
    ...
    re_path(
        r"^export/orders/$", views.ExportOrdersView.as_view(), name="export_orders"
    ),
    path(
        "export/accountbooks",
